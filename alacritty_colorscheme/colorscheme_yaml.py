...
# Re-export the static methods so we don't break previous code
get_applicable_colorscheme = YamlManager.get_applicable_colorscheme
replace_colorscheme = YamlManager.replace_colorscheme
get_applied_colorscheme = YamlManager.get_applied_colorscheme
